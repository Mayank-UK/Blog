...
@section('content')
    <div class="container col-md-6 col-md-offset-3 shadow p-3">
        <div class="well well bs-component">
            ...
            <form action="{{ action('Admin\UsersController@delete', $user->id) }}"  class='form-horizontal' method='post'>
                {!! csrf_field() !!}
                <button type="submit" class="btn btn-primary">{{ __('Delete this user') }}</button>
            </form>
        </div>
    </div>
@endsection